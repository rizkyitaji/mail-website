...
<body>
  ...
  if($_SESSION['status']!="login"){
    ...
    include '../../koneksi.php'; 
    $query = mysqli_query($koneksi,"SELECT * FROM HH");
  ?>
	<div class="menu">
	    <header>
			...
			<table class="show" border="1" width="100%">
				...
				<tbody>
					...
					<tr>
						...
						print("<td><a class=\"hapus\" href=\"hapus-hh.php?kode=$No_Urut\"onClick = \"return confirm('Surat $No_Urut dihapus?')\">Hapus</a></td>");
		 				?>
					</tr>
					<?php } ?>
					<?php } ?>
