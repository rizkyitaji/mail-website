<?php
  include '../../koneksi.php';
    ...
    $urut = mysqli_query($koneksi,"SELECT max(No_Urut) as maxNo FROM HH");
...
<html>
<head>
  <title>Input Mail-HH | BPHN</title>
...
<body>
  ...
  <div class="menu">
    ...
    <div class="isi">
      ...
      <form action="save-hh.php" method="POST">
        <table class="tabel">
          <tr>
            <td>Tanggal</td>
            <td>:</td>
          ...
          <tr>
            <td>No. Urut</td>
            <td>:</td>
            <td><input class="form1" name="var" type="text" placeholder="PHN/PHN1" size="25" maxlength="25" required> - <input name="kode" type="text" placeholder="HH.01.01" class="form2" size="25" maxlength="25" required> - <input class="form3" name="no" type="text" value="<?php echo $format; ?>" size="20" maxlength="20" required></td>
          </tr>
          <tr> 
