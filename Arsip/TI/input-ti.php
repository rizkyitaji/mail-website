<?php
  include '../../koneksi.php';
    ...
    $urut = mysqli_query($koneksi,"SELECT max(No_Urut) as maxNo FROM TI");
...
<html>
<head>
  <title>Input Mail-TI | BPHN</title>
...
<body>
  ...
  <div class="menu">
    ...
    <div class="isi">
      <h1 class="judul">DATA DAN INFORMASI (TI)</h1>
      <form action="mail-ti.php">
        <table>
          <tr>
      ...
      <form action="save-ti.php" method="POST">
        <table class="tabel">
          <tr>
            <td>Tanggal</td>
            <td>:</td>
          ...
          <tr>
            <td>No. Urut</td>
            <td>:</td>
            <td><input class="form1" name="var" type="text" placeholder="PHN/PHN1" size="25" maxlength="25" required> - <input name="kode" type="text" placeholder="TI.01.01" class="form2" size="25" maxlength="25" required> - <input class="form3" name="no" type="text" value="<?php echo $format; ?>" size="20" maxlength="20" required></td>
          </tr>
          <tr> 
