...
<body>
  ...
  if($_SESSION['status']!="login"){
    ...
    include '../../koneksi.php'; 
    $query = mysqli_query($koneksi,"SELECT * FROM KP");
  ?>
	<div class="menu">
		<header>
			...
			<table class="show" border="1" width="100%">
				...
				<tbody>
					...
					<tr>
						...
						print("<td><a class=\"hapus\" href=\"hapus-kp.php?kode=$Perihal\"onClick = \"return confirm('Surat $Perihal dihapus?')\">Hapus</a></td>");
		 				?>
					</tr>
					<?php } ?>
					<?php } ?>
